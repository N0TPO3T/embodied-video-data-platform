  ...
  return (
    <div className="page-stack">
      ...
      <div className="metric-grid">
        ...
        <MetricCard label="待锁定积分" value="328.60 分" detail="进入下个积分周期" icon={Wallet} tone="amber" />
      </div>
      <div className="dashboard-grid"><section className="content-card content-card-wide"><div className="card-heading"><div><h2>最近数据</h2><p>跟踪你的视频处理和质检进度</p></div><button className="text-button" onClick={() => navigate("/collector/submissions")}>查看全部</button></div><div className="skeleton-table"><span /><span /><span /><span /></div></section><aside className="content-card"><div className="card-heading"><div><h2>今日采集建议</h2><p>优先补充紧缺场景</p></div></div><div className="recommend-list"><div><em>01</em><span><strong>工作台组装</strong><small>紧缺度 92%</small></span></div><div><em>02</em><span><strong>户外园艺</strong><small>紧缺度 87%</small></span></div><div><em>03</em><span><strong>家庭收纳</strong><small>紧缺度 78%</small></span></div></div></aside></div>
    </div>
  );
}
