  ...
  beforeEach(() => {
    ...
    getAnnotationOperationsMock.mockResolvedValue({
      ...
      summary: {
        ...
        usage: { scope: "successful_final_response_only", runsWithReportedUsage: 0, totalReportedInputTokens: 0, totalReportedOutputTokens: 0, averageReportedTokensPerSuccessfulRun: null, averageReportedModelLatencyMs: null },
      },
  ...
  it("renders independent annotation runs and opens the run-id review route", async () => {
    ...
    getAnnotationOperationsMock.mockResolvedValue({
      ...
      summary: {
        ...
        usage: { scope: "successful_final_response_only", runsWithReportedUsage: 1, totalReportedInputTokens: 100, totalReportedOutputTokens: 20, averageReportedTokensPerSuccessfulRun: 120, averageReportedModelLatencyMs: 2_000 },
      },
