  ...
  return (
    <div className="page-stack">
      <div className="page-heading">
        ...
        <button ref={inviteTriggerRef} className="button button-primary" onClick={() => setInviteOpen(true)}>邀请成员</button>
      </div>
      ...
      <InviteMemberModal open={inviteOpen} onClose={() => setInviteOpen(false)} returnFocusRef={inviteTriggerRef} />
    </div>
  );
}
